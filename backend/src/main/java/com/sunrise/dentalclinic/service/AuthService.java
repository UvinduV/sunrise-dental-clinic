...
public class AuthService {
    ...
    public LoginResponseDTO login(LoginRequestDTO request) {
        ...
        return new LoginResponseDTO(authentication.getName(), role, "Login successful");
    }
    ...
    public LoginResponseDTO register(RegisterRequestDTO request) {
        ...
        return new LoginResponseDTO(user.getUsername(), user.getRole(), "Registration successful");
    }
}
